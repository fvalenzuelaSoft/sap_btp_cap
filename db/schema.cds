...
entity zorden_fv {
  key id           : String(36) not null;
      ...
      Items        : Association to zitems_fv
...
entity zitems_fv {
  ...
  key id_item          : String(4) not null;
      ...
      Orders           : Association to zorden_fv;
}

entity SelOrden     as select * from zorden_fv;
entity SelItems     as select * from zitems_fv;
entity ProjSelOrden as projection on zorden_fv;
entity ProjSelItems as projection on zitems_fv;
